...
(Vulnerable                           Droid)
        ...
        if vdroid == ("1"):
            ...
            if payload == ("1"):
                ...
                print("VLPORT FOR PAYLOAD :" +VLport3)
                ...
                print("VDROID FOR PAYLOAD :" +VLport4)
                ...
                print("VDROID FOR PAYLOAD :" +VLport5)
            ...
            if payload1 == ("1"):
                ...
                print("VLPORT FOR PAYLOAD :" +VLport113)
                VLname113 = input("VDROID==>[NAME] ")
                print("VLNAME FOR PAYLOAD :" +VLname113)
                ...
                print("VDROID FOR PAYLOAD :" +VLport114)
                VLname114 = input("VDROID==>[NAME] ")
                print("VDROID FOR PAYLOAD :" +VLname114)
                ...
                print("VDROID FOR PAYLOAD :" +VLport115)
                VLname115 = input("VDROID==>[NAME] ")
                print("VDROID FOR PAYLOAD :" +VLname115)
